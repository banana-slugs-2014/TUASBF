...
//create three initial fields
	...
	//     $node += '<p><label for="var'+displayCount+'">Question '+displayCount+': </label><input type="text" name="var'+displayCount+'" id="var'+displayCount+'"><span class="removeVar">Remove Question</span></p>';
	// }
	// //add them to the DOM
	// $('form').prepend($node);
	// //remove a textfield    
